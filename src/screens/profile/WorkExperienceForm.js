import {
  ...
  export const WorkExperienceForm = ({ navigation, route }) => {
    ...
    const onSubmitForm = (data) => {
      const userDataCopy = [...userData.workExperience];
      ...
      Promise.all(
        ...
        firestore()
          ...
          .update({ workExperience: userDataCopy })
          .then(() => {
            ...
            <KeyboardAvoidingView>
              ...
              <View style={styles.smallButtonContainer}>
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate("WorkExperienceHome")}
                >
